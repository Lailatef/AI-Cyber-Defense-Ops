...
- `rules/` — hand-authored curated Sigma detection rules (YAML), distinct from the upstream rule set. Currently 15 rules (13 from Module 4, 2 added in Module 5), predominantly credential-access/lateral-movement focused:
